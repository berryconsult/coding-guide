...
Guia objetivo de lint/format para Maia API e Maia App.
...
5. **Dúvidas de processo:** Veja a seção [Processos de Desenvolvimento](#processos-de-desenvolvimento)
6. **Dúvidas técnicas:** Veja [Guias de Tecnologia](#guias-de-tecnologia)
7. **Dúvidas de testes:** Veja [Qualidade e Testes](#qualidade-e-testes)
